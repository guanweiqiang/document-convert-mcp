...
```json
{
  ...
  "pageSize": "'A4' | 'Letter' (optional)",
  "theme": "'default' | 'github' | 'academic' (optional)",
  ...
  "strictMarkdown": "boolean (optional)",
...
```json
{
  ...
  "imageDir": "string (optional)",
  "engine": "'pandoc' | 'markitdown' (optional, default 'pandoc')",
  "cleanForLLM": "boolean (optional)",
  "overwrite": "boolean (optional, default false)"
}
```
...
> **Warning**: PDF 转 Markdown 是内容提取，不是版式或语义结构还原。
